        ...
        <div class="ibox float-e-margins">
            ...
            <div>
                ...
                <div class="ibox-content profile-content">
                    <h4><strong>{{ $users->name }}</strong></h4>
                    <p><i class="fa fa-map-marker"></i> {{ $users->email }}</p>
                    <h5>
                        Lazt.us
                    </h5>
                    ...
                    <p class="text-justify">
                       Tu plan Actual : <strong> {{ $users->plan }} </strong> <a href="#">actualiza tu plan para obtener beneficios</a>
                    </p>
                    
                    <div class="row m-t-lg">
                        <div class="col-md-6">
                            <span class="bar">Tipo de usuario</span>
                            <h5><strong>Tipo: </strong> {{ $users->type }}</h5>
                        </div>
                        <div class="col-md-6">
                            <span class="line">{{ __('Profile_Cod') }}</span>
                            <h5><strong>Cod: </strong> {{ $users->cod_user }}</h5>
                        </div>
                    </div>
                    <div class="user-button">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ url('admin/angels') }}" class="btn btn-primary btn-sm btn-block"><i class="fa fa-envelope"></i> Invitar </a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{route('profiles.edit', $users->id)}}" class="btn btn-danger btn-sm btn-block"><i class="fa fa-edit"></i> Editar Perfil </a>
                            </div>
                        </div>
                    </div>
                </div>
